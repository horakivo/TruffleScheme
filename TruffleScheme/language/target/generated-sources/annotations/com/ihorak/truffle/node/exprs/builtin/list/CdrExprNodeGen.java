...
@GeneratedBy(CdrExprNode.class)
public final class CdrExprNodeGen extends CdrExprNode {

    @Child private SchemeExpression list_;
    @CompilationFinal private int state_0_;

    private CdrExprNodeGen(SchemeExpression list) {
        this.list_ = list;
    }
    ...
    public Object executeGeneric(VirtualFrame frameValue) {
        ...
        if (state_0 != 0 /* is-state_0 doCdr(SchemeCell) */ && listValue_ instanceof SchemeCell) {
            SchemeCell listValue__ = (SchemeCell) listValue_;
            return doCdr(listValue__);
        }
    ...
    private Object executeAndSpecialize(Object listValue) {
        ...
        if (listValue instanceof SchemeCell) {
            ...
            this.state_0_ = state_0 = state_0 | 0b1 /* add-state_0 doCdr(SchemeCell) */;
            return doCdr(listValue_);
        }
    ...
    public static CdrExprNode create(SchemeExpression list) {
        return new CdrExprNodeGen(list);
    }
