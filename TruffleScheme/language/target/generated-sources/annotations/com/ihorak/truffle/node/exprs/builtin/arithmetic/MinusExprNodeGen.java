...
@GeneratedBy(MinusExprNode.class)
public final class MinusExprNodeGen extends MinusExprNode {

    @Child private EvalArgumentsNode arguments_;
    @CompilationFinal private int state_0_;

    private MinusExprNodeGen(EvalArgumentsNode arguments) {
    ...
    public Object executeGeneric(VirtualFrame frameValue) {
        ...
        if (state_0 != 0 /* is-state_0 subtractAnyNumberOfLongs(long[]) */ && argumentsValue_ instanceof long[]) {
            long[] argumentsValue__ = (long[]) argumentsValue_;
            return subtractAnyNumberOfLongs(argumentsValue__);
        }
    ...
    private long executeAndSpecialize(Object argumentsValue) {
        ...
        if (argumentsValue instanceof long[]) {
            ...
            this.state_0_ = state_0 = state_0 | 0b1 /* add-state_0 subtractAnyNumberOfLongs(long[]) */;
            return subtractAnyNumberOfLongs(argumentsValue_);
        }
    ...
    public static MinusExprNode create(EvalArgumentsNode arguments) {
        return new MinusExprNodeGen(arguments);
    }
