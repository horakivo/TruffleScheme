...
@TypeSystem({long.class, double.class, SchemeBigInt.class, boolean.class, TruffleString.class, SchemeList.class, SchemeSymbol.class, UserDefinedProcedure.class})
