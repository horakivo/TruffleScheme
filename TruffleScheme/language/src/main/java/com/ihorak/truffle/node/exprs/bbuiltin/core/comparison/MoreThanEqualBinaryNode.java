...
public abstract class MoreThanEqualBinaryNode extends BinaryBooleanOperationNode {
    ...
    @TruffleBoundary
    @Specialization
    protected boolean moreThenEqualBigInts(SchemeBigInt left, SchemeBigInt right) {
