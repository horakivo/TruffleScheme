...
public class MaterializableLambdaExprNode extends SchemeExpression {

    public final RootCallTarget callTarget;
    public final int amountOfArguments;
    private final String name;

    public MaterializableLambdaExprNode(RootCallTarget callTarget, int amountOfArguments, String name) {
