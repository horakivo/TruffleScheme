...
3. Následně je možné spustit interpretr dvěma způsoby:
   ...
   pozn. jednotlivé složky obsahují soubor scm-component.jar, který lze využít k instalici jazyka jako komponenty
...
5. Následně je možné projekt sestavit (build) pomocí příkazu: 'mvn clean package -DskipTests' ve složce src/TruffleScheme.
...
6. V tuto chvíli je možné interpret spustit pomocí výše vygenerovaného programu 'scm_native'
Např.: ./TruffleScheme/native/scm_native TruffleScheme/language/tests/fib.scm

7. Možné je také využít komponentu a jazyk nainstalovat pomocí Graal Updater.
...
8. V případě, že je komponenta úspěšně nainstalována, interpret je možné spustit dvěmi způsoby
